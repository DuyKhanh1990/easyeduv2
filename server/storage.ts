import {
  ...
  type CrmPipelineGroup, type InsertCrmPipelineGroup,
...
export interface IStorage {
  ...
  checkLocationUsage(id: string): Promise<boolean>;
  deleteLocation(id: string, isSuperAdmin?: boolean): Promise<void>;
  ...
  getStudentsMinimal(params: { allowedLocationIds: string[]; isSuperAdmin: boolean; locationId?: string; limit?: number; searchTerm?: string }): Promise<{ id: string; fullName: string; code: string; phone: string | null; type: string | null; locations: { locationId: string }[] }[]>;
  ...
  // CRM Configuration
  getCrmPipelineGroups(): Promise<CrmPipelineGroup[]>;
  createCrmPipelineGroup(data: InsertCrmPipelineGroup): Promise<CrmPipelineGroup>;
  updateCrmPipelineGroup(id: string, data: Partial<InsertCrmPipelineGroup>): Promise<CrmPipelineGroup>;
  deleteCrmPipelineGroup(id: string): Promise<void>;
  ...
  getCrmSchools(): Promise<CrmSchool[]>;
  createCrmSchool(data: InsertCrmSchool): Promise<CrmSchool>;
  updateCrmSchool(id: string, data: Partial<InsertCrmSchool>): Promise<CrmSchool>;
  deleteCrmSchool(id: string): Promise<void>;
  ...
  getCrmRegistrationFormFields(): Promise<{ fieldKey: string; isVisible: boolean; isRequired: boolean }[]>;
  upsertCrmRegistrationFormField(fieldKey: string, isVisible: boolean, isRequired?: boolean): Promise<{ fieldKey: string; isVisible: boolean; isRequired: boolean }>;
  ...
  getAllCourseProgramContents(params?: { page?: number; pageSize?: number; search?: string }): Promise<{ items: any[]; total: number }>;
  ...
  excludeClassSessions(params: { classId: string; fromSessionId: string; toSessionId: string; reason: string; userId: string; weekdays?: number[]; skipRecalculate?: boolean }): Promise<void>;
  getClassExclusions(classId: string): Promise<any[]>;
  getClassCycles(classId: string): Promise<Array<{ weekdays: number[]; fromSessionIndex: number; toSessionIndex: number | null; label: string }>>;
  ...
  getFinanceVouchers(searchTerm?: string): Promise<FinanceVoucher[]>;
  createFinanceVoucher(data: InsertFinanceVoucher): Promise<FinanceVoucher>;
  updateFinanceVoucher(id: string, data: Partial<InsertFinanceVoucher>): Promise<FinanceVoucher>;
  deleteFinanceVoucher(id: string): Promise<void>;
  getFinanceVoucherUsages(id: string, opts: { page: number; limit: number; search?: string; status?: string }): Promise<{ data: import("./storage/finance.storage").VoucherUsageRow[]; total: number; voucher: FinanceVoucher | null }>;
  ...
  getInvoicesByCategory(filters?: { locationId?: string; dateFrom?: string; dateTo?: string; allowedLocationIds?: string[] | null; isSuperAdmin?: boolean }): Promise<{
  ...
  getRevenueByLocation(filters?: { locationId?: string; dateFrom?: string; dateTo?: string; allowedLocationIds?: string[] | null; isSuperAdmin?: boolean }): Promise<{
  ...
  getCustomerDebtSummary(filters?: { locationId?: string; dateFrom?: string; dateTo?: string; allowedLocationIds?: string[] | null; isSuperAdmin?: boolean }): Promise<{
  ...
  getDefaultInvoicePrintTemplate(invoiceType: string, scheduleCount?: number | null): Promise<InvoicePrintTemplateRow | null>;
  ...
  migrateCrmPipelineGroupsSchema(): Promise<void>;
...
export class DatabaseStorage implements IStorage {
  ...
  async getClassCycles(classId: string): Promise<Array<{ weekdays: number[]; fromSessionIndex: number; toSessionIndex: number | null; label: string }>> {
    return sessionStorage.getClassCycles(classId);
  }
  ...
  async updateCourseProgram(id: string, data: any): Promise<CourseProgram> {
    return courseStorage.updateCourseProgram(id, data);
  }

  async deleteCourseProgram(id: string): Promise<void> {
    return courseStorage.deleteCourseProgram(id);
  }
  ...
  async getAllCourseProgramContents(params?: { page?: number; pageSize?: number; search?: string }): Promise<{ items: any[]; total: number }> {
    return courseStorage.getAllCourseProgramContents(params);
  }
  ...
  async addClassStudents(classId: string, studentIds: string[], userId: string, status?: string): Promise<void> {
    return classStorage.addClassStudents(classId, studentIds, userId, status);
  }
  ...
  async excludeClassSessions(params: { classId: string; fromSessionId: string; toSessionId: string; reason: string; userId: string; weekdays?: number[]; skipRecalculate?: boolean }): Promise<void> {
  ...
  async checkLocationUsage(id: string): Promise<boolean> {
    return staffStorage.checkLocationUsage(id);
  }

  async deleteLocation(id: string, isSuperAdmin?: boolean): Promise<void> {
    return staffStorage.deleteLocation(id, isSuperAdmin);
  }
  ...
  async getStudentClassTabs(params: {
    allowedLocationIds: string[];
    isSuperAdmin: boolean;
    viewScope?: 'all' | 'own';
    viewerStaffId?: string;
  }) {
    return studentStorage.getStudentClassTabs(params);
  }

  async getStudentsMinimal(params: { allowedLocationIds: string[]; isSuperAdmin: boolean; locationId?: string; limit?: number; searchTerm?: string }) {
  ...
  async getCrmPipelineGroups(): Promise<CrmPipelineGroup[]> {
    return studentStorage.getCrmPipelineGroups();
  }

  async createCrmPipelineGroup(data: InsertCrmPipelineGroup): Promise<CrmPipelineGroup> {
    return studentStorage.createCrmPipelineGroup(data);
  }

  async updateCrmPipelineGroup(id: string, data: Partial<InsertCrmPipelineGroup>): Promise<CrmPipelineGroup> {
    return studentStorage.updateCrmPipelineGroup(id, data);
  }

  async deleteCrmPipelineGroup(id: string): Promise<void> {
    return studentStorage.deleteCrmPipelineGroup(id);
  }
  ...
  async getCrmSchools(): Promise<CrmSchool[]> {
    return studentStorage.getCrmSchools();
  }

  async createCrmSchool(data: InsertCrmSchool): Promise<CrmSchool> {
    return studentStorage.createCrmSchool(data);
  }

  async updateCrmSchool(id: string, data: Partial<InsertCrmSchool>): Promise<CrmSchool> {
    return studentStorage.updateCrmSchool(id, data);
  }

  async deleteCrmSchool(id: string): Promise<void> {
    return studentStorage.deleteCrmSchool(id);
  }
  ...
  async getCrmRegistrationFormFields(): Promise<{ fieldKey: string; isVisible: boolean; isRequired: boolean }[]> {
    return studentStorage.getCrmRegistrationFormFields();
  }
  async upsertCrmRegistrationFormField(fieldKey: string, isVisible: boolean, isRequired?: boolean): Promise<{ fieldKey: string; isVisible: boolean; isRequired: boolean }> {
    return studentStorage.upsertCrmRegistrationFormField(fieldKey, isVisible, isRequired);
  }
  ...
  async getStudentClassSessions(params: { studentId: string; classId: string; page: number; limit: number }) {
    return studentStorage.getStudentClassSessions(params);
  }
  ...
  // FINANCE - VOUCHERS
  // ==========================================
  async getFinanceVouchers(searchTerm?: string): Promise<FinanceVoucher[]> {
    return financeStorage.getFinanceVouchers(searchTerm);
  }

  async createFinanceVoucher(data: InsertFinanceVoucher): Promise<FinanceVoucher> {
    return financeStorage.createFinanceVoucher(data);
  }

  async updateFinanceVoucher(id: string, data: Partial<InsertFinanceVoucher>): Promise<FinanceVoucher> {
    return financeStorage.updateFinanceVoucher(id, data);
  }

  async deleteFinanceVoucher(id: string): Promise<void> {
    return financeStorage.deleteFinanceVoucher(id);
  }

  async getFinanceVoucherUsages(id: string, opts: { page: number; limit: number; search?: string; status?: string }) {
    return financeStorage.getFinanceVoucherUsages(id, opts);
  }

  async getFinanceVoucherAudienceStudents(id: string) {
    return financeStorage.getFinanceVoucherAudienceStudents(id);
  }

  // ==========================================
  // FINANCE - INVOICES
  // ==========================================
  async getInvoices(filters: Parameters<typeof financeStorage.getInvoices>[0] = {}) {
    return financeStorage.getInvoices(filters);
  }

  async getInvoicesSummary(filters: {
    locationId?: string;
    locationNames?: string[];
    search?: string;
    dateFrom?: string;
  ...
  async getInvoicesByCategory(filters: { locationId?: string; dateFrom?: string; dateTo?: string; allowedLocationIds?: string[] | null; isSuperAdmin?: boolean } = {}) {
    return financeStorage.getInvoicesByCategory(filters);
  }

  async getRevenueByLocation(filters: { locationId?: string; dateFrom?: string; dateTo?: string; allowedLocationIds?: string[] | null; isSuperAdmin?: boolean } = {}) {
    return financeStorage.getRevenueByLocation(filters);
  }

  async getCustomerDebtSummary(filters: { locationId?: string; dateFrom?: string; dateTo?: string; allowedLocationIds?: string[] | null; isSuperAdmin?: boolean } = {}) {
    return financeStorage.getCustomerDebtSummary(filters);
  }
  ...
  async splitInvoiceSchedule(scheduleId: string, splitAmount: number, userId?: string | null): Promise<{ updated: any; affected: any }> {
  ...
  async updateInvoiceScheduleStatus(scheduleId: string, status: string, userId?: string | null): Promise<any> {
    return financeStorage.updateInvoiceScheduleStatus(scheduleId, status, userId);
  }

  async updateInvoiceStatus(invoiceId: string, status: string, userId?: string): Promise<any> {
    return financeStorage.updateInvoiceStatus(invoiceId, status, userId);
  }
  ...
  async migrateCrmPipelineGroupsSchema(): Promise<void> {
    return financeStorage.migrateCrmPipelineGroupsSchema();
  }
  ...
  async getDefaultInvoicePrintTemplate(invoiceType: string, scheduleCount?: number | null): Promise<InvoicePrintTemplateRow | null> {
    return financeStorage.getDefaultInvoicePrintTemplate(invoiceType, scheduleCount);
  }
