-- These insert schemas and current writers omit created_at, relying on the
-- PostgreSQL now() default under the Asia/Ho_Chi_Minh session convention.
BEGIN;
...
--   backup_table text;
--   target_tables text[] := ARRAY[
--     'finance_transaction_categories','staff_rewards','staff_advances',
--     'staff_hr_salary_configs'
--   ];
-- BEGIN
--   FOREACH target_table IN ARRAY target_tables LOOP
