...
**How to apply:** Keep date edits as a small inline save/cancel interaction, validate the effective pair of dates server-side, and use the existing “Sửa hoá đơn” audit event with localized field labels.