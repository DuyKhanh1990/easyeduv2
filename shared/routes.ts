...
export const api = {
    ...
    create: {
      ...
      input: z.object({
        ...
        assignments: z.array(z.object({
          ...
          omicallExtension: z.string().max(50).optional().nullable(),
          omicallPassword: z.string().max(255).optional().nullable(),
  ...
  students: {
    ...
    removeFromSessionsConfirm: {
      ...
      input: z.object({
        ...
        orphanAction: z.enum(["keep", "remove", "waiting"]).optional(),
      }),
      responses: {
    ...
    create: {
      ...
      input: z.object({
        ...
        codeAutoGenerated: z.boolean().optional(),
        usernameAutoGenerated: z.boolean().optional(),
  ...
  crm: {
    pipelineGroups: {
      list: { path: "/api/crm/pipeline-groups", method: "GET" },
      create: { path: "/api/crm/pipeline-groups", method: "POST", input: insertCrmPipelineGroupSchema },
      update: { path: "/api/crm/pipeline-groups/:id", method: "PUT", input: insertCrmPipelineGroupSchema.partial() },
      delete: { path: "/api/crm/pipeline-groups/:id", method: "DELETE" },
    },
    relationships: {
    ...
    schools: {
      list: { path: "/api/crm/schools", method: "GET" },
      create: { path: "/api/crm/schools", method: "POST", input: insertCrmSchoolSchema },
      update: { path: "/api/crm/schools/:id", method: "PUT", input: insertCrmSchoolSchema.partial() },
      delete: { path: "/api/crm/schools/:id", method: "DELETE" },
    },
    requiredFields: {
    ...
    registrationFields: {
      list: { path: "/api/crm/registration-form-fields", method: "GET" },
      upsert: { path: "/api/crm/registration-form-fields", method: "PUT" },
    },
  },
  courses: {
  ...
  classes: {
    ...
    cycles: { path: "/api/classes/:id/cycles", method: "GET" },
    ...
    close: { path: "/api/classes/:id/close", method: "POST" },
  },
  classSessions: {
