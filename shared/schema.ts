...
export const studentSessions = pgTable("student_sessions", {
  ...
  onlineClickedAt: timestamp("online_clicked_at", { withTimezone: true }),
  onlineEndedAt: timestamp("online_ended_at", { withTimezone: true }),
...
export const storeIssueReceipts = pgTable("store_issue_receipts", {
  ...
  promotionKeys: jsonb("promotion_keys").default(sql`'[]'::jsonb`),
  surchargeKeys: jsonb("surcharge_keys").default(sql`'[]'::jsonb`),
  manualPromotionRows: jsonb("manual_promotion_rows").default(sql`'[]'::jsonb`),
  manualSurchargeRows: jsonb("manual_surcharge_rows").default(sql`'[]'::jsonb`),
  hasInvoice: boolean("has_invoice").default(false),
  invoiceNote: text("invoice_note"),
...
export const storeIssueReceiptItems = pgTable("store_issue_receipt_items", {
  ...
  manualPromotionRows: jsonb("manual_promotion_rows").default(sql`'[]'::jsonb`),
  manualSurchargeRows: jsonb("manual_surcharge_rows").default(sql`'[]'::jsonb`),
  promotionAmount: numeric("promotion_amount").default("0"),
