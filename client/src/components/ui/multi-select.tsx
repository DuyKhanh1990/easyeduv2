                ...
                filteredOptions.map((option) => {
                  ...
                  return (
                    <li
                      ...
                      className="relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 mx-1 text-sm outline-none hover:bg-accent hover:text-accent-foreground"
                    >
                      <div
                        className={cn(
