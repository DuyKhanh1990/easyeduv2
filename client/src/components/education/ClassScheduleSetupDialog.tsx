...
export function ClassScheduleSetupDialog({
  ...
  const activeStaff = (staffList as any[]).map((s: any) => ({ ...s, _isActive: s.status === "Hoạt động" }));
        ...
        <div className="flex-1 overflow-auto space-y-5 py-2 pr-1">
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <SearchableMultiSelect
                options={activeStaff.map((s: any) => ({ value: s.id, label: s.fullName, isActive: s._isActive }))}
                value={managerIds}
                  ...
                  {weekdays.map(wd => (
                    <div key={wd} className="grid grid-cols-12 gap-2 items-center">
                      ...
                      <div className="col-span-5">
                        <SearchableMultiSelect
                          options={activeStaff.map((t: any) => ({ value: t.id, label: t.fullName, isActive: t._isActive }))}
