...
// Subset of fields shown in the registration form config tab
export const REGISTRATION_FORM_FIELDS: CrmConfigurableField[] = [
  // "fullName" is always shown (system field), not togglable
  { key: "locationId", label: "Cơ sở", group: "contact" },
  { key: "phone", label: "Số điện thoại", group: "contact" },
  { key: "email", label: "Email", group: "contact" },
  { key: "dateOfBirth", label: "Sinh nhật", group: "contact" },
  { key: "address", label: "Địa chỉ", group: "contact" },
  { key: "parentName", label: "Họ tên phụ huynh", group: "parent" },
  { key: "parentPhone", label: "Số điện thoại phụ huynh", group: "parent" },
  { key: "customerSourceIds", label: "Nguồn khách hàng", group: "crm" },
  { key: "salesByIds", label: "Nhân viên Sale", group: "crm" },
  { key: "note", label: "Ghi chú", group: "other" },
];
