...
export function TaskList() {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2 flex-wrap bg-white border border-border rounded-xl px-3 py-2">
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((task, idx) => {
                    ...
                    return (
                      <tr
                        key={task.id}
                        className={cn("border-b transition-colors bg-white hover:bg-muted/30",
