  ...
  return (
    <div className="bg-white rounded-lg border border-border shadow-sm overflow-hidden" data-testid={`card-question-${index}`}>
      ...
      <div className="px-5 py-4 space-y-3">
        ...
        {question.mediaImageUrl && (
          <img
            src={toMediaUrl(question.mediaImageUrl)}
            alt="Question image"
        ...
        {question.mediaAudioUrl && (
          <audio
            src={toMediaUrl(question.mediaAudioUrl)}
            controls
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {opt.imageUrl && (
                      <img src={toMediaUrl(opt.imageUrl)} alt={`Option ${opt.id}`} className="mt-1 max-h-24 rounded border object-contain" />
                    )}
                  </div>
                </div>
              );
...
export function ExamDetail() {
  ...
  const { data: sections = [], isLoading: sectionsLoading } = useQuery<ExamSection[]>({
  ...
  useEffect(() => {
    if (!examId || !exam || sectionsLoading || sections.length > 0 || autoSessionCreatedRef.current) return;
        ...
        <main className="flex-1 flex flex-col overflow-hidden bg-muted/30 min-w-0">
          ...
          <div className="px-6 py-2 border-b bg-background flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              data-testid="btn-add-section-tab"
              title="Thêm session mới"
              aria-label="Thêm session mới"
              className="flex h-8 w-8 items-center justify-center rounded-full border border-emerald-500 bg-emerald-500 text-white shadow-sm transition-colors hover:bg-emerald-600"
            >
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="w-64">
                      <DropdownMenuItem
                        ...
                        data-testid="menu-pick-from-bank"
                      ...
                      <DropdownMenuItem
                        ...
                        data-testid="menu-import-questions"
                        className="flex items-center gap-2 cursor-pointer"
                      >
                      ...
                      <DropdownMenuItem
                        ...
                        data-testid="menu-ai-generate-section"
                        className="flex items-center gap-2 cursor-pointer text-purple-700 focus:text-purple-700"
                      >
