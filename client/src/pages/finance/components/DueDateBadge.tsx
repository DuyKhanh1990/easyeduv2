export function DueDateBadge({ dueDate }: { dueDate: string | null | undefined }) {
  if (!dueDate) return <span className="text-slate-500 text-[11px] font-medium">Không có hạn</span>;
  ...
  return <span className="text-[11px] font-medium text-blue-600">Chưa đến hạn</span>;
}
