...
const SAMPLE_DATA = {
  ...
  ghi_chu: "Ghi chú mẫu cho hóa đơn",
...
const VARIABLES: VariableDef[] = [
  ...
  { group: "Khách hàng & Hoá đơn", label: "Ngày tạo hóa đơn", key: "ngay_tao", description: "{{ngay_tao}}" },
  { group: "Khách hàng & Hoá đơn", label: "Ngày hiện tại in phiếu", key: "ngay_in_phieu", description: "{{ngay_in_phieu}}" },
  { group: "Khách hàng & Hoá đơn", label: "Ngày thanh toán", key: "ngay_thanh_toan", description: "{{ngay_thanh_toan}}" },
  { group: "Khách hàng & Hoá đơn", label: "Hạn thanh toán", key: "han_thanh_toan", description: "{{han_thanh_toan}}" },
...
const VARIABLE_HELP: Record<string, { meaning: string; example: string }> = {
  ...
  ngay_tao: { meaning: "Ngày tạo/lập hóa đơn hoặc phiếu thu đang in.", example: "06/09/2026" },
  ngay_in_phieu: { meaning: "Ngày hiện tại tại thời điểm in phiếu.", example: "16/09/2026" },
  ngay_thanh_toan: { meaning: "Ngày hóa đơn được ghi nhận thanh toán; để trống nếu hóa đơn chưa thanh toán.", example: "06/09/2026" },
  han_thanh_toan: { meaning: "Hạn thanh toán được đặt cho hóa đơn.", example: "30/09/2026" },
  lop: { meaning: "Tên lớp học gắn với hóa đơn.", example: "A1 - Toán nâng cao" },
  ghi_chu: { meaning: "Ghi chú đã lưu trên hóa đơn.", example: "Thu học phí tháng 9" },
  noi_dung: { meaning: "Mã cũ tương thích với các mẫu in trước đây.", example: "Thu học phí tháng 9" },
